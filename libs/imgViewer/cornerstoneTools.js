...
(function($, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function onImageRendered(e, eventData) {
        ...
        for (var i = 0; i < toolData.data.length; i++) {
            ...
            var data = toolData.data[i];
            // data.color = cornerstoneTools.toolColors.getToolColor();
...
(function($, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function startDrawing(eventData) {
        ...
        var measurementData = {
            ...
            active: true,
            handles: [] ,
            activeColor: cornerstoneTools.toolColors.getActiveColor(),
            fillColor: cornerstoneTools.toolColors.getFillColor(),
            toolColor: cornerstoneTools.toolColors.getToolColor()
        };
...
// console.log(data);
    ...
    cornerstoneTools.rectangleRoi.setLabel = setLabel
    ...
    function createNewMeasurement(mouseEventData) {
        ...
        var measurementData = {
            ...
            handles: {
                    ...
                    x: mouseEventData.currentPoints.image.x,
                    y: mouseEventData.currentPoints.image.y + deltaY,
                    highlight: true,
                    active: true,
                    hasBoundingBox: true
                }
